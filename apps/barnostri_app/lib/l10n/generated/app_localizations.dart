...
abstract class AppLocalizations {
  ...
  /// Prefix for order header
  ///
  /// In en, this message translates to:
  /// **'Order #'**
  String get orderHeader;

  /// Indicator for current status step
  ///
  /// In en, this message translates to:
  /// **'Current'**
  String get currentStatus;

  /// Snackbar message when login fails with details
  ///
  /// In en, this message translates to:
  /// **'Login error: {error}'**
  String loginErrorDetailed(Object error);

  /// Displayed on a page that does not exist
  ///
  /// In en, this message translates to:
  /// **'Page not found'**
  String get pageNotFound;

  /// Shown when QR scanning is not available on web
  ///
  /// In en, this message translates to:
  /// **'QR scanning not supported on web'**
  String get qrScanningNotSupportedOnWeb;

  /// Shown when an unauthenticated user tries to checkout
  ///
  /// In en, this message translates to:
