...
class OrderService extends GuardedStateNotifier<OrderState> {
  ...
  @override
  OrderState setLoading(OrderState state, bool isLoading) =>
      state.copyWith(isLoading: isLoading);

  @override
  OrderState setError(OrderState state, String? error) =>
